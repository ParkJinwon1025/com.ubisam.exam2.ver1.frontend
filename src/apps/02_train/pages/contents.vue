  ...
  <v-app id="inspire">
    ...
    <v-navigation-drawer permanent v-model="drawer">
      <v-list nav>
        ...
        <v-divider></v-divider>
        <v-list-item to="/contents/trains"> {{ $t("frontend.contents.trains.title") }} </v-list-item>
        <v-list-item to="/contents/trainDrivers"> {{ $t("frontend.contents.trainDrivers.title") }} </v-list-item>
        <v-list-item to="/contents/trainRoutes"> {{ $t("frontend.contents.trainRoutes.title") }} </v-list-item>
        <v-list-item to="/contents/trainStations"> {{ $t("frontend.contents.trainStations.title") }} </v-list-item>
        <v-divider></v-divider>
