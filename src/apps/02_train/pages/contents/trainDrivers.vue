  ...
  <v-container class="pa-4" fluid>
    <v-card>
      <v-card-title class="d-flex align-center pe-2">
        ...
        {{ $t("frontend.contents.trainDrivers.title") }}&nbsp;
        <!-- 
        ///////////////////////////
        // Search Field Start
        //////////////////////////
      ...
      <v-dialog v-model="dialog" persistent width="800">
        <v-card prepend-icon="mdi-update" :title="$t('frontend.contents.trainDrivers.title')" :subtitle="editForm.name">
          <v-card-text>
            <v-form validate-on="eager" @update:model-value="dialogValidate">
              ...
              <v-text-field v-model="editForm.trainDriverName" :rules="[$rules.requried]" label="trainDriverName"
                placeholder="trainDriverName" hint="........" variant="outlined"></v-text-field>

              <v-text-field v-model="editForm.trainDriverLicenseNumber" :rules="[$rules.requried]"
                label="trainDriverLicenseNumber" placeholder="trainDriverLicenseNumber" hint="........"
                variant="outlined"></v-text-field>

              <v-text-field v-model="editForm.trainDriverPhone" :rules="[$rules.number]" label="trainDriverPhone"
                placeholder="trainDriverPhone" hint="......." variant="outlined"></v-text-field>
...
export default {
  data: () => ({
    ...
    config: {
      ...
      headers: [
        ...
        { key: "trainDriverName", title: "TrainDriverName", align: "center" },
        { key: "trainDriverLicenseNumber", title: "TrainDriverLicenseNumber", align: "center" },
        { key: "trainDriverPhone", title: "trainDriverPhone", align: "center" },
      ...
      initForm: {
        id: undefined,
        trainDriverName: undefined,
        trainDriverLicenseNumber: undefined,
        trainDriverPhone: undefined,
        trains: undefined,
      }
      /////////////////////////////////
      // Config End
  ...
  methods: {
    ...
    ////////////////////////////////////////
    handleCreate() {
      return $exampleServer.trainDrivers.create(this.editForm);
    },
    handleRead(entity) {
      return $exampleServer.trainDrivers.read(entity);
    },
    handleUpdate() {
      return $exampleServer.trainDrivers.update(this.editForm);
    },
    handleDelete() {
      return $exampleServer.trainDrivers.delete(this.editForm);
    },
    handleSearch(query) {
      return $exampleServer.trainDrivers.search(this.searchForm, query);
    },
    handleEntities(res) {
      this.entitiesTotal = res.page.totalElements;
      this.entities = res._embedded.trainDrivers;
      return res;
    },
    handleEntity(res) {
